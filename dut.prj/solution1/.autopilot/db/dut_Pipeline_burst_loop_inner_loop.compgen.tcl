...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_icmp_30ns_30ns_1_2_1 BINDTYPE {op} TYPE {seteq} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_icmp_30ns_30ns_1_2_1_sub BINDTYPE {op} TYPE {seteq} IMPL {auto} LATENCY 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_add_30ns_30ns_30_2_1 BINDTYPE {op} TYPE {add} IMPL {fabric} LATENCY 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_s_TVALID { I 1 bit } in_s_TDATA { I 32 vector } } \
} "
} else {
