...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_icmp_31ns_31ns_1_2_1 BINDTYPE {op} TYPE {seteq} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_icmp_31ns_31ns_1_2_1_sub BINDTYPE {op} TYPE {seteq} IMPL {auto} LATENCY 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_add_31ns_31ns_31_2_1 BINDTYPE {op} TYPE {add} IMPL {fabric} LATENCY 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_add_32ns_32ns_32_2_1 BINDTYPE {op} TYPE {add} IMPL {fabric} LATENCY 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_icmp_32ns_32ns_1_2_1 BINDTYPE {op} TYPE {seteq} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_icmp_32ns_32ns_1_2_1_sub BINDTYPE {op} TYPE {seteq} IMPL {auto} LATENCY 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dut_add_32ns_32ns_32_1_1 BINDTYPE {op} TYPE {add} IMPL {dsp} LATENCY 0
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_s_TDATA { I 32 vector } in_s_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { in_s_TREADY { O 1 bit } in_s_TLAST { I 1 vector } } \
} "
} else {
