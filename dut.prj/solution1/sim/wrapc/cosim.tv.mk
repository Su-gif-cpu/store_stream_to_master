...
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := T:/Xilinx/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --sysroot=T:/Xilinx/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
...
LFLAG += -lpthread
LFLAG += -L T:/Xilinx/Vitis/2024.2/vcxx/lib/clang/14.0.6/lib/windows -lclang_rt.builtins-x86_64
...
$(ObjDir)/test_store_stream_to_master.cpp_pre.cpp.tb.o : test_store_stream_to_master.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling test_store_stream_to_master.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
